  ...
  useEffect(() => {
    const calculateSpacing = () => {
      ...
      if (isMobile) {
        ...
        // sur tous les téléphones (9.5% de la hauteur d'écran - remonté de 0.5% par rapport à 10%)
        const carouselSpacingPercent = 0.095; // 9.5% de la hauteur d'écran (10% - 0.5% pour remonter le carrousel)
      ...
      const newSpacing = {
        ...
        carouselSpacingPercent: isMobile ? 0.095 : null, // Pourcentage pour mobile (9.5% de la hauteur d'écran - 10% - 0.5% pour remonter)
            ...
            >
              ...
              <p
                ...
                style={{
                  ...
                  marginBottom: spacing.isMobile ? 'calc(1px + 0.5vh)' : 'calc(1px + 0.5vh)'
                }}
              >
